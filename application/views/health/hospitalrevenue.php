    ...
    $i      = 1;
      ...
      if($i==1)
            ...
            if($i<=10)
            {
                ...
                $moneyrangemobile ['1st-10th']  +=$x['ap_money'];
            }
            if($i<=20 && $i>11)
            {
                $moneyrangemobile ['11th-20th']  +=$x['ap_money'];
            }
            if($i<=31 && $i>20)
            {
                $moneyrangemobile ['21st & Above']  +=$x['ap_money'];
            }
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card hidden-xs hidden-sm">
                                ...
                                <div class="card-content">
                                    <h4 class="title">My Revenue for the month of <b><?=date('M,Y',strtotime($monrev[1]['date']));?> for <?= $department['name'];?> department.</b></h4>
                              ...
                              <?php
                                if(count($doc))
                                {
                                  ...
                                  foreach ($doc as $x) {
                                    ?>
                                      <tr>
                                        <td><b><a href="<?= base_url('Health/docdetails/'.$x['id']);?>">Dr. <?= $x['user_name'];?></a></b></td>
                                        <td>
                                            <?php
                                              if($x['monthlyrevenue']=='')
                                              {
                                                ...
                                                $x['monthlyrevenue']  = floor(($x['monthlyrevenue']*100)/$charge);
                                              }
                                             ?>
                                          &#x20B9; <?= $x['monthlyrevenue'];?>
                                   ...
                                   <?php
                                   	...
                                   	foreach($monrev as $x)
                                   	{
                                          ...
                                          $x['ap_money']  = floor(($x['ap_money']*100)/$charge);
                                   			...
                                   			?>
                                   				<tr>                                   					
                                   					<th style="width:50%;"> <?= date('d,M y',strtotime($x['date']));?></th>
                                   					<th style="width:50%;">&#x20B9; <?= $x['ap_money'];?></th>
                                   				</tr>
                                   			<?php
                                   		}
                                   		$i++;
...
function findappointments(){
	var year = $("#year").val();
	var month = $("#month").val();
	location.href="<?= base_url('Health/hospitalrevenue/'.$this->uri->segment(3).'/');?>"+year+"-"+month;
}
</script>
