                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-header card-chart"  data-background-color="purple">
                                    <div class="ct-chart hidden-sm hidden-xs" style="height:300px;" id="emailsSubscriptionChart"></div>
                                    <div class="ct-chart hidden-lg hidden-md" style="height:300px;" id="emailsSubscriptionChart2"></div>
                                </div>
