                                    ...
                                    <div class="col-md-12" >
                                    	<?php
                                    		if(count($ap))
                                    		{
			                                                ...
			                                                foreach ($ap as $x) {
			                                                    ?>
			                                                        <tr>
			                                                            ...
			                                                            <td><a href="<?= base_url('patient/details/'.$x['ap_patient_id']);?>"><?= $x['user_name'];?></a></td>   
			                                                            <td><?= $x['ap_id'];?></td>   
			                                                            <td>
                                    			...
                                    			?>
                                    				<div class="alert alert-success">No appointments found for  <?= date('F', mktime(0, 0, 0, $_GET['m'], 10)); ?>, <?= $_GET['y'];?> </div>
                                    			<?php
                                    		}
                                    	?>
                                    </div>                                   
