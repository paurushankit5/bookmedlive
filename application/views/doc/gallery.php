                        ...
                        if(count($gallery))
                        {
                            ...
                            foreach($gallery as $img)
                            {
                                ?>
                                    <div class="col-sm-3" style="margin-bottom: 40px;">
                                        <img src="<?= base_url('img/gallery/'.$img['id'].'/'.$img['image_name']);?>" style="height:250px;width:100%;"class="img img-responsive img-thumbnail" alt="Gallery Image">
                                        <center><button onClick="deliimage('<?= $img['id'];?>','<?= $img['image_name'];?>',this);" class="btn btn-danger"><i class="fa fa-trash"></i></button></center>
                                    </div>
                                <?php
                            }
                            echo "</div>";
...
<div id="picmodal" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <!-- Modal content-->
    <form method="post" action="<?= base_url('Doc/addgallery');?>" enctype="multipart/form-data">
