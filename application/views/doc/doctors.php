                            ...
                            <?php
                                if(count($doc)){
                                    ...
                                    foreach($doc as $x){
                                        ...
                                        <div class="card">
                                            <div class="card-header" data-background-color="purple">
                                                <h4 class="title"><?= $x['user_name'];?> <a href="<?= base_url('Health/docdetails/'.$x['id']);?>" class="btn btn-warning pull-right"><i class="fa fa-info-circle"></i> Details</a></h4>
                                               <b> <p class="category">
                                                    Status: 
                                                    <?php
                                                        if($x['is_active']==0)
                                    ...
                                    ?>
                                        <div class="card">
                                            <div class="card-header" data-background-color="purple">
                                                <h4 class="title">No Doctors Found. <a href="<?= base_url('Health/adddoc');?>" class="btn btn-info pull-right"><i class="fa fa-plus"></i> Doctors</a></h4>
                                                <p class="category">PLease add doctors to your clinic</p>
                                            </div>
