                                                     ...
                                                     <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group label-floating">
                                                                ...
                                                                <input type="text" name="user_alt_mob" required value="<?php echo set_value('user_alt_mob'); ?>"   pattern="[0-9]{10}" maxlength="10"   class="form-control">
                                                            </div>
                                                        </div>                                                         
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group label-floating">
                                                                ...
                                                                <label><input type="radio"  name="user_gender"   value="Others"     > Others </label>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group label-floating">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-group label-floating">
                                                                    <label class="control-label"> Provide a small and basic details about the doctor.</label>
                                                                    <textarea class="form-control" name="user_about" rows="5"><?php echo set_value('user_about'); ?></textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
