...
<head>
  ...
  <title> Bookmediz Indian State</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">  Indian States</li> 
			  		...
			  		if(count($states))
			  		{
			  			...
			  			foreach ($states as $y) {
			  				?>
			  					<tr>
			  					 	<td><?= $i++;?></td>
			  						<td><a href="<?= base_url('hosadmin/citylist/'.$y['id']);?>"><?= $y['name'];?></a></td>
			  						<td>
  ...
  <!-- Trigger the modal with a button -->
	...
	<div id="specmodal" class="modal fade" role="dialog">
	  <div class="modal-dialog">
	  	<form class="form " method="post" action="<?= base_url('hosadmin/storestate');?>">
	    <!-- Modal content-->
	...
	<div id="editspecmodal" class="modal fade" role="dialog">
	  <div class="modal-dialog">
	  	<form class="form " method="post" action="<?= base_url('hosadmin/updatestate');?>">
	    <!-- Modal content-->
	    <div class="modal-content">
	      <div class="modal-header">
	        <button type="button" class="close" data-dismiss="modal">&times;</button>
  	...
  	function editnow(id,name){
   	...
   	function delstate(id){
   		...
   		if(r==true)
   		{
   			$.ajax({
   				type 	: 	"POST",
   				url 	: 	"<?= base_url('hosadmin/delstate');?>",
   				data 	: 	{"id" : id},
   				success : 	function(){
   					location.reload();
   				}
