<?php
	...
	$activehosdoc		=	$array['activehosdoc'];
	$pendinghosdoc		=	$array['pendinghosdoc'];
?>
<!DOCTYPE html>
<html>
<head>
  ...
  <title> Bookmediz Hospital</title>
		 	...
		 	<div class="row">
				...
				<div class="col-md-3 col-sm-6 col-xs-12">
				  <div class="info-box">
					...
					<div class="info-box-content">
						<span class="info-box-text">Active Hospital Doctor</span>
					  <span class="info-box-number"><?= $activehosdoc; ?> </span>
					</div>
					<!-- /.info-box-content -->
				  </div>
				  <!-- /.info-box -->
				...
				<div class="col-md-3 col-sm-6 col-xs-12">
				  <div class="info-box">
					...
					<div class="info-box-content">
						<span class="info-box-text">Pending Hospital Doctor</span>
					  <span class="info-box-number"><?= $pendinghosdoc; ?> </span>
					</div>
					<!-- /.info-box-content -->
				  </div>
				  <!-- /.info-box -->
      		...
      		?>	
      			<div class="box">
			        <div class="box-header with-border">
			          <h3 class="box-title"> Pending Hospital  </h3>
			          <div class="box-tools pull-right">
			          		<a href="<?= base_url('hosadmin/pendinghospital');?>">View All</a>
			          </div>
			        </div>
			        <div class="box-body"> 
      		<?php
      		foreach ($pendingclinic as $x) {
      			?> 	
					...
					<div class="panel panel-primary">
					  <div class="panel-heading"><a href="<?= base_url('Hosadmin/hosdetails/'.$x['id']);?>" style="color:white;font-size:16px;"> <?= $x['user_name'];?></a></div>
					  <div class="panel-body">
					  	...
					  	<div class="col-md-9">
					  		...
					  		?>
					  		<br>
					  		<a href="<?= base_url('Hosadmin/hosdetails/'.$x['id']);?>" class="btn btn-primary btn-block">Details</a>
					 	 	</div>
					  	</div>
					  	</div>
					  </div>
      ...
      <?php
      	...
      	{	
      		?>	
      			<div class="box">
			        <div class="box-header with-border">
			          <h3 class="box-title"> Active Hospital  </h3>
			          <div class="box-tools pull-right">
			          		<a href="<?= base_url('hosadmin/activehospital');?>">View All</a>
			          </div>
			        </div>
			        <div class="box-body"> 
      		<?php
