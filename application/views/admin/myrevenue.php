...
<head>
  ...
  <title> Bookmediz My Revenue for <?= date('F', mktime(0, 0, 0, $_GET['m'], 10)).", ".$_GET['y']; ?></title>
...
<?php include('includes/header.php');?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        My Revenue for <?= date('F', mktime(0, 0, 0, $_GET['m'], 10)).", ".$_GET['y']; ?>
        <small></small>
      </h1>
      <ol class="breadcrumb">
        ...
        <li class="active">  My Revenue for <?= date('F', mktime(0, 0, 0, $_GET['m'], 10)).", ".$_GET['y']; ?></li> 
    ...
    <section class="content">
      ...
      <div class="row">
      	<div class="col-sm-6 col-sm-offset-3">
      		<div class="box">
		        <div class="box-header with-border">
		          <h3 class="box-title"> Find Revenue </h3>
			  	 ...
			  	 <?php
			  	 	if(count($indidoc))
			  	 	{
			  	 		...
			  	 		foreach ($indidoc as $doc) {
			  	 			...
			  	 			$totalthismonth += $doc['month'];
			  	 			$totaltoday += $doc['today'];
			  	 			$totalthistoday += $doc['today'];

			  	 		}
			  	 		?>
			  	 		<tr>
			  	 			<th>Total:</th>
			  	 			<td><b>&#x20B9; <?= $totalthistoday;?></b></td>
			  	 			<td><b>&#x20B9; <?= $totalthismonth;?></b></td>
			  	 		</tr>
			  	 		<?php
			  	 	}
			  	 ?>
    ...
    <!-- /.content -->
		...
		<script type="text/javascript">
			...
			var chart = Highcharts.chart('chart', {
			    ...
			    title: {
			        text: ' My Revenue for <?= date('F', mktime(0, 0, 0, $_GET['m'], 10)).", ".$_GET['y']; ?>'
			    },
			...
			function findappointments(){
				var year = $("#year").val();
				var month = $("#month").val();
				location.href="<?= base_url('Hosadmin/myrevenue?m=');?>"+month+"&y="+year;
			} 
