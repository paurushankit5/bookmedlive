			        ...
			        <div class="box-body"> 
			 		...
			 		<div class="box">
						<div class="box-header with-border">
						    ...
						    <div class="box-tools pull-right">
						     	<button class="btn btn-primary"onclick="loginasuser('<?= $clinic['id'];?>','<?= base_url('Health/doctors');?>');"   ><i class="fa fa-pencil"></i></button>
						    </div>
						</div>
						<div class="box-body"> 
							<?php
						...
						<div class="box">
						    <div class="box-header with-border">
						        ...
						        <div class="box-tools pull-right">
						          	<button class="btn btn-primary"onclick="loginasuser('<?= $clinic['id'];?>','<?= base_url('Helath/profile');?>');"   ><i class="fa fa-pencil"></i></button>
						        </div>
						    </div>
						    <div class="box-body"> 
						    	 <table class="table table-responsive">
						    		<?php
						    			if(!isset($clinic['account']))
						    			{
						    				?>
						    					<tr><td>No account Added.</td></tr>
						    				<?php
						    			}
						    			else if(!count($clinic['account']))
						    			{
						    				?>
						    					<tr><td>No account Added.</td></tr>
						    				<?php
