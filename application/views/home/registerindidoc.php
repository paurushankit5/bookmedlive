...
<head>
  ...
  <title>Bookmediz: Register as Individual Doctor</title>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-10 offset-md-1 col-lg-8 offset-lg-0">
				<form method="post" action="<?= base_url('register/storeindidoc');?>">
					
				<!-- Edit Personal Info -->
				<div class="widget personal-info">
						<h1 class="text text-center text-danger"> Register as Individual Doctor</h1>
						<?php 
