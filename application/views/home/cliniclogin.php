...
<head>
  ...
  <title>Bookmediz: Clinic Login</title>
  <meta charset="utf-8">
...
<div class="col-sm-6 col-sm-offset-3" style="background-color:white;margin-top:100px;box-shadow:0px 0px 5px 5px gray;"  >
  <h2 class="text text-center text-primary" ><b>Clinic Login </b>	</h2>
  <?php
  ...
  ?>
  <form class="form-horizontal" method="post" action="<?=base_url('cliniclogin/verifylogin');?>">
    <div class="form-group">
      <label class="control-label col-sm-2" for="clinic_email">Email:</label>
      <div class="col-sm-10">
        <input type="email" class="form-control" id="clinic_email" name="clinic_email" placeholder="Enter email">
      </div>
    </div>
    <div class="form-group">
      <label class="control-label col-sm-2" for="clinic_password">Password:</label>
      <div class="col-sm-10">          
        <input type="password" class="form-control" id="clinic_password" name="clinic_password" placeholder="Enter password">
      </div>
    </div>
   <!--<div class="form-group"> 
    ...
    <div class="form-group">        
      <div class="col-sm-offset-2 col-sm-10">
		...
		<a href="<?= base_url('clinicregistration');?>">New User?</a><br>
...
<div id="myModal" class="modal fade" role="dialog">
	...
	function forgotpassword()
	{
		...
		else
		{
			$.ajax({
					type		:	'POST',
					url			:	'<?= base_url('cliniclogin/forgotpassword');?>',
					data		:	'clinic_email='+clinic_email,
