...
<head>
  ...
  <title>Bookmediz : Transaction Failure  </title>
    ...
    <div class="row">
      ...
      <div class="col-md-8 col-md-offset-2">
          ...
          <center>
             <div class=="col-md-12">
             	<article>
             		<h1 class="text text-danger"><b>OOPSSSS!.. Transaction Failure</b></h1>
             		<p class="text text-danger">The payment has been declined by payment gateway.</p>
             	</article>
             </div>
          </center>
            <?php 
