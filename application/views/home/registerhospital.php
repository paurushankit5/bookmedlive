...
<head>
  ...
  <title>Bookmediz: Register as Hospital</title>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-10 offset-md-1 col-lg-8 offset-lg-0">
				<form method="post" action="<?= base_url('register/storehospital');?>">
					
				<!-- Edit Personal Info -->
				<div class="widget personal-info">
						<h1 class="text text-center text-danger">Register As Hospital</h1>
						<?php 
						...
						<div class="form-group">
						    <label for="user_name">Hospital Name</label>
