...
<head>
  ...
  <title>Bookmediz: Register as Diagnosis Center</title>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-10 offset-md-1 col-lg-8 offset-lg-0">
				<form method="post" action="<?= base_url('register/storediagnosis');?>">
					
				<!-- Edit Personal Info -->
				<div class="widget personal-info">
						<h1 class="text text-center text-danger"> Register as Diagnosis Center</h1>
						<?php 
