	  ...
	  <div class="panel panel-default">
	    ...
	    <div id="collapse2" class="panel-collapse collapse in">
	      <div class="panel-body">
				  ...
				  <input type="range" min="100" max="1000" value="<?= $midprice; ?>" step="50" class="slider"  id="myRange">
				  <br>
  ...
  <script type="text/javascript">
	  ...
	  var slider = document.getElementById("myRange");
		...
		slider.onchange = function() { 
		    var day 	=	getday();
		 	loadnow=0;
		  	getresults(queries,day,this.value,'0','0');
		  	pricechange = true;
		}
	  //console.log(queries);
	  function getresults(queries,day,price,offset,load){
	  	 if (day === undefined) {
		    day = '';
		  }
		   if (offset === undefined) {
		 ...
		 if (price === undefined) {
	  	...
	  	$.ajax({
	  		type 	: 	"POST",
	  		url 	: 	"<?= base_url('Search/ajaxfindspeciality');?>",
	  		data 	: 	{
	  						"data"	: 	queries,
	  						"day"	: 	day,
	  						"offset": 	offset,
	  ...
	  function adddday(){
		...
		getresults(queries,day,money,'0','0');
	  }
