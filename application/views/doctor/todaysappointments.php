									...
									<tr>
										...
										<?php
											if($x['appointment_payment']=='Transaction Successful')
											{
												?>
													<td>
													<a href="<?= base_url('doctordashboard/reschedule/'.$x['appointment_id']);?>" class="btn btn-warning btn-block">Reschedule Appointment</a>
													<button onClick="confirmcancel('<?= $x['appointment_id'];?>');" class="btn btn-danger btn-block">Cancel Appointment</button>
													</td>
												<?php
											}
											else
