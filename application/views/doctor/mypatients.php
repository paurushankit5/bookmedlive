					...
					<tbody>
						<?php
							if(count($patients))
							{
								...
								foreach($patients as $x)
								{
									...
									<tr>
										...
										<td><a href="<?= base_url('doctordashboard/viewpatientdetails/'.$x['patient_id']);?>" class="btn btn-warning">View Details</a></td>
							...
							else
							{
								?>
								<tr>
									<td colspan="5"><div class="alert alert-warning"><b>No patients found.</b></div></td>
								</tr>
								<?php
							}
						?>
