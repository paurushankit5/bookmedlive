                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 hidden-xs hidden-sm">
                            <div class="card">
                                <div class="card-header card-chart" data-background-color="orange">
                                    <div class="ct-chart" style="height:300px;" id="emailsSubscriptionChart"></div>
                                </div>
                                <div class="card-content">
                                    <h4 class="title">My Appointments for the month of <?= date('M Y');?></h4>
                                    <p class="category">Appointment for this month</p>
                                </div>
                        ...
                        <div class="col-md-12 hidden-md hidden-lg">
                            <div class="card">
                                <div class="card-header card-chart" data-background-color="orange">
                                    <div class="ct-chart" style="height:300px;" id="emailsSubscriptionChart2"></div>
                                </div>
                                <div class="card-content">
                                    <h4 class="title">My Appointments for the month of <?= date('M Y');?></h4>
                                    <p class="category">Appointment for this month</p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-12">
                            <div class="card">
                                <div class="card-header" data-background-color="orange">
                                    <h4 class="title"><i class="fa fa-comments-o"></i> Questions</h4>
                                ...
                                <div class="card-content table-responsive">
                                            ...
                                            <?php
                                                if(count($que))
                                                {
                                                    foreach ($que as $q) {
                                                    ?>
                                                        <h5><a href="<?= base_url('Patient/Details/'.$q['id']);?>"><?= $q['user_name'];?></a> <span class="pull-right" style="font-size:12px;"><?= date("d,M Y",strtotime($q['question_add_time']));?> </span></h5> 
                                                        <p>Q. <b><?= $q['question_name'];?></b></p>
                                                        <form method="post" action="<?= base_url('Diagnosis/storeans');?>">
                                                        <div class="col-xs-9">
                                                          <input type="hidden"  name="question_id" value="<?= $q['question_id'];?>">
                                                          <input type="hidden"  name="question_patient_id" value="<?= $q['question_patient_id'];?>">
                                                          <input type="text" placeholder="Enter Your Answer here" class="form-control" name="question_ans">
                                                        </div>
                                                          <div class="col-xs-3">
                                                            <button type="submit" class="btn btn-outline-secondary btn-sm" type="button"><i class="fa fa-plus"></i></button>
                                                          </div>
                                                      </form>
...
function findappointments(){
    var year = $("#year").val();
    var month = $("#month").val();
    location.href="<?= base_url('Diagnosis/findmonthappointments');?>?y="+year+"&m="+month;
}
</script>
