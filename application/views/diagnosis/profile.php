                        ...
                        <div class="col-md-8">
                            ...
                            <div class="card editcard hidden">
                                ...
                                <div class="card-content">
                                    ...
                                    ?>
                                    <form method="post" action="<?= base_url('Diagnosis/updateprofile');?>">
                                        <div class="row">
                                            <div class="col-md-6">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group label-floating">
                                                        <label class="control-label"> Provide a small and basic details about your clinic/hospital.</label>
...
<div id="picmodal" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <!-- Modal content-->
    <form method="post" action="<?= base_url('Diagnosis/updatepic');?>" enctype="multipart/form-data">
...
<div id="accountmodal" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
    <form method="post" action="<?= base_url('Diagnosis/storeaccountdetails');?>">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
...
<div id="mapmodal" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <!-- Modal content-->
    <form method="post" action="<?= base_url('Diagnosis/storemap');?>" enctype="multipart/form-data">
