                                    ...
                                    <?php
                                        if(count($ap))
                                        {
                                            ...
                                            foreach($ap as $x)
                                            {
                                                ...
                                                ?>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="card-header" data-background-color="<?= $cardclass; ?>">
                                                                <h4 class="title"><?= $x['user_name'];?> (<?= $x['ap_id'];?>)</h4>
                                                         ...
                                                         <div class="col-md-8">
                                                            <table class="table">
                                                                <tr>
                                                                    <td>Date:</td>
                                                                    <th><?= date('d,M Y',strtotime($x['ap_date']));?></b></th>
                                                                </tr>
                                                                <tr>
                                                                    <td>Amount:</td>
                                                                    <th>&#x20B9; <?= $x['ap_money'];?></b></th>
                                                                ...
                                                                <tr>
                                                                    <td>Booked On:</td>
                                                                    <th><?= date('d,M Y',strtotime($x['created_at']));?></b></th>
                                                                </tr>
                                                ...
                                                else if($x['ap_status'] ==  3)
                                                {
                                                    ...
                                                    ?>
                                                        ...
                                                        <a href="<?= base_url('Diagnosis/Reschedule/'.$x['ap_id']);?>" class="btn btn-warning <?= $class1; ?> <?= $class2; ?>" style="width:140px;">Reschedule</a>
                                            ...
                                            <div class="alert alert-warning">
                                                <p class="text text-center">Whoops!.... No Records found for <?= date('d-M, Y', strtotime($count));?>.</p>
                                            </div>
                                            <?php
                                        }
                                    ?>    
    ...
    function changestatus(ap_id,str){
           ...
           if(r == true)
           {
                $.ajax({
                    ...
                    url     :   "<?= base_url('Diagnosis/changeapstatus');?>",
                    beforeSend : function(){$('.loadingDiv').show();},
                    success    : function(data){
                                $('.loadingDiv').hide();
                                 location.reload();   
       ...
       function findappointments(){
        ...
        if(ap_date=='')
        {
            ...
            location.href="<?= base_url('Diagnosis/findappointments/');?>"+ap_date;
        }
       }
</script>
