                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-header card-chart"  data-background-color="purple">
                                    <div class="ct-chart hidden-sm hidden-xs" style="height:500px;" id="emailsSubscriptionChart"></div>
                                    <div class="ct-chart hidden-md hidden-lg" style="height:500px;" id="emailsSubscriptionChart2"></div>
                                </div>
...
function findappointments(){
	var year = $("#year").val();
	var month = $("#month").val();
	location.href="<?= base_url('Diagnosis/myrevenue/');?>"+year+"-"+month;
}
</script>
