                        ...
                        <div class="col-md-12" style="min-height: 500px;">
                                        ...
                                        <div class="card">
                                            <div class="card-header" data-background-color="purple">
                                                <h4 class="title">Services <button onclick="$('.form').slideDown();$('.info').hide();" class="btn btn-warning pull-right"><i class="fa fa-plus"></i> Services</button></h4>
                                               <b> <p class="category">
                                                    Add/Edit Services 
                                            ...
                                            <div class="card-content">
                                                ...
                                                <div class="col-md-12  form" style="display: <?= $class; ?>">
                                                	<form class="form form-horizontal" method="post" action="<?= base_url('Health/storeservices');?>">
                                                	<?php
                                                		if(count($allservice))
                                                		{
                                                			foreach ($allservice as $x) {
                                                				?>
                                                					<div class="col-sm-4">
	                                                					<div class="col-sm-12" style="padding:10px;">
	                                                						<label><input type="checkbox" <?php if(in_array($x['service_name'],$demo)){echo "checked ";} ?>name="service_id[]"value="<?= $x['id'];?>"> <?= $x['service_name'];?></label>
	                                                					</div>
                                                					</div>
                                                				<?php
                                                			}
