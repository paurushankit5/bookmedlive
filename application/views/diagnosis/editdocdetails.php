                            ...
                            <div class="card">
                                ...
                                <div class="card-content">
                                    ...
                                    <form method="post" action="<?= base_url('Health/updatedocprofile/');?>">
                                         ...
                                         <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group label-floating">
                                                    ...
                                                    <input type="text" name="user_time" required   value="<?php echo $user['user_time']; ?>"  pattern="[0-9]{1-2}" maxlength="2" class="form-control">
                                                </div>
                                            </div> 
                                        </div>
                                        ...
                                        <div class="col-md-6"> 
                                            <div class="form-group label-floating">
                                                <label class="control-label">Experirence</label>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group label-floating">
                                                        <label class="control-label"> Provide a small and basic details about you.</label>
