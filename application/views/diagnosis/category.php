...
<head>
    ...
    <title>Bookmediz: Test Category</title>
                        ...
                        <div class="col-md-12" style="min-height: 500px;">
                            ...
                            <div class="card">
                                <div class="card-header" data-background-color="purple">
                                    <h4 class="title"> Test Category
                                   
                                    </h4>
                                </div>
                                <div class="card-content">
                                <div class="col-md-12">
                                    <form class="form "   method="post" action="<?= base_url('diagnosis/storecategory');?>">
                    					<?php
                    						if(count($allcat))
                    						{
                    							foreach($allcat as $x)
                    							{
                    								?>
                    									<div class="col-md-4">
                    										 <label><input type="checkbox" <?php if(in_array($x['id'],$cat)) {echo "checked";} ?> value="<?= $x['id'];?>"  name="cat_id[]"> <?= $x['cat_name'];?></label>
                    									</div>
                    								<?php
                    							}
                    						}
