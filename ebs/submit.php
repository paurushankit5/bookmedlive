...
$hashData = "0643c3a6fd2c960d5253ba71073b6b7f"; //Pass your Registered Secret Key
...
<body >
<center><h1 class="text-center" style="margin-top:200px;">Please Do not press back button or refresh the page.</h1></center>
<form action="https://secure.ebs.in/pg/ma/payment/request" name="payment" method="POST" style="display: none;">
<table>
...
<button onclick="document.payment.submit();" id="btn"> SUBMIT </button>
</form>
